    ...
    <section id="pay" className="py-24 bg-dark-bg px-8">
      ...
      <div className="glass rounded-3xl p-12 max-w-[860px] mx-auto flex flex-col md:flex-row gap-12 items-center shadow-2xl border-white/5">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <a href="https://wa.me/919730668645" target="_blank" className="flex items-center gap-2 bg-[#25D366] text-white px-8 py-3.5 rounded-xl text-sm font-black uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-xl">
            💬 Activate Now
          </a>
        </div>
      </div>
